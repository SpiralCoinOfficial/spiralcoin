# Exchange Submission Email Templates

Use these templates to submit SpiralCoin (SPRC) for listing to major exchanges. Replace bracketed fields as appropriate.

---

## Binance – Listing Request
Subject: Listing Request – SpiralCoin (SPRC)
...
- Submission Pack: See attached or https://spiralcoin.net/EXCHANGE_SUBMISSION_PACK.md
...
## Coinbase – Asset Listing
Subject: SpiralCoin (SPRC) – Asset Listing Inquiry
...
## Kraken – Market Listing Request
Subject: SpiralCoin (SPRC) – Market Listing Request
...
Subject: SpiralCoin (SPRC) Listing Application
